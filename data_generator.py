...
class DataGenerator(object):
    ...
    def __init__(self, num_samples_per_class, batch_size, config={}):
        ...
        if FLAGS.datasource == 'sinusoid':
            ...
            data_folder = config.get('data_folder', '/content/maml/data/omniglot_resized')
            ...
            self.dim_output = self.num_classes
            metatrain_folder = config.get('metatrain_folder', '/content/maml/data/miniImagenet/train')
            if FLAGS.test_set:
                metaval_folder = config.get('metaval_folder', '/content/maml/data/miniImagenet/test')
            else:
                metaval_folder = config.get('metaval_folder', '/content/maml/data/miniImagenet/val')
